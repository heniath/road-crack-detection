...
refined version of \cite{smith1981identification};
...
obtained by Rabinowitz in \cite{smith1981identification}, who showed the existence of
infinitely many subharmonics both in the subquadratic and superquadratic
case, with suitable growth conditions on $H'$. Again the duality
approach enabled Clarke and Ekeland in \cite{smith1981identification} to treat the
same problem in the convex-subquadratic case, with growth conditions on
$H$ only.

Recently, Michalek and Tarantello (see \cite{smith1981identification} and \cite{czajkowski2001grid})
